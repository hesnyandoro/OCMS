      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {/* Total Outstanding */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-[#D93025] dark:border-red-600">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">Total Outstanding</p>
                  <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Ksh {kpis.outstanding.toLocaleString()}</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-[#F59E0B] dark:border-dark-gold-primary">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">Avg Cost Per Kg</p>
                  <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Ksh {kpis.avgCostPerKg.toFixed(2)}</h3>
                  <p className="text-xs text-gray-500 dark:text-dark-text-tertiary mt-1">Per kilogram delivered</p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-[#1B4332] dark:border-dark-green-primary">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">Total Paid Out</p>
                  <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Ksh {kpis.totalPaid.toLocaleString()}</h3>
                  <p className="text-xs text-green-600 dark:text-green-400 mt-1 flex items-center gap-1">
                    <TrendingDown size={12} />
                    Completed payments
                  </p>
                </div>
                <div className="bg-[#1B4332] dark:bg-dark-green-secondary p-3 rounded-lg">
                  <DollarSign size={24} className="text-white" />
                </div>
              </div>
            </div>
            ...
            {/* Total Deliveries */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-[#10B981] dark:border-emerald-600">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">Total Deliveries</p>
                  <h3 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{kpis.totalDeliveries.toLocaleString()}</h3>
                  <p className="text-xs text-gray-500 dark:text-dark-text-tertiary mt-1">{kpis.totalKgs.toLocaleString()} kgs total</p>
                </div>
                <div className="bg-[#10B981] dark:bg-emerald-600 p-3 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Farmers receiving the most payments - priority management</p>
              </div>
            </div>
                ...
                <tbody>
                  {topPerformers.map((farmer, index) => (
                    <tr key={index} className={`${index % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-700'} hover:bg-[#F3F4F6] dark:hover:bg-gray-700 transition-colors`}>
                      ...
                      <td className="py-4 px-6 font-semibold text-[#1B4332] dark:text-dark-green-primary">{farmer.name}</td>
                      <td className="py-4 px-6 font-bold text-gray-900 dark:text-gray-100">Ksh {farmer.total.toLocaleString()}</td>
                      <td className="py-4 px-6 text-gray-700 dark:text-gray-400">{farmer.count}</td>
                      <td className="py-4 px-6 text-gray-700 dark:text-gray-400">Ksh {(farmer.total / farmer.count).toFixed(2)}</td>
                      <td className="py-4 px-6">
